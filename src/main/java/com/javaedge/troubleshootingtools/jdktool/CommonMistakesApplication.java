package com.javaedge.troubleshootingtools.jdktool;
...
public class CommonMistakesApplication {
    ...
    public static void main(String[] args) throws InterruptedException {
        //bad: java -jar common-mistakes-0.0.1-SNAPSHOT.jar -Xms1g -Xmx1g
        //right: java -Xms1g -Xmx1g -jar common-mistakes-0.0.1-SNAPSHOT.jar

        //bad: java -XX:ThreadStackSize=256k common-mistakes-0.0.1-SNAPSHOT.jar
