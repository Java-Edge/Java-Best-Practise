package com.javaedge.serialization.redistemplate;
...
public class RedisTemplateController {
    ...
    public void init() throws JsonProcessingException {
        redisTemplate.opsForValue().set("redisTemplate", new User("javaedge", 36));
        stringRedisTemplate.opsForValue().set("stringRedisTemplate", objectMapper.writeValueAsString(new User("javaedge", 36)));
    }
    ...
    @GetMapping("right2")
    public void right2() {
        User user = new User("javaedge", 36);
